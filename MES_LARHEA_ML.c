...
const u8 __far ML_MSA_1[MAX_MSA][32] = {
    ...
    #else					   
    /* MSA n.  4 */        "@A177           "							//"      remove cup" "  Boisson pr�te "
                           "                ",							//"Please          " "enlever tasse   ",
    #endif	 
...
#else
    /* MSA n. 167 */        "@A210           "						//"driptray        "   "Bac  eaux us�es "
                            "                ",						 //"inside? 10=START",  "insere? 10=Avant",     
#endif
...
const u8 __far ML_MSAP_1[MAX_MSAP][32] = {
    ...
    /* MSP n. 128 */       "@B345�\x08         "                        //"cup sensor      "  "D�tecteur tasse   "
                           "                ",                          //"1=Enable       \x08", "Gobelet 1=hab. \x08",
    #endif
    ...
    /* MSP n.  167 */      "@B216�\6\7\x08       "                      //"quick menu      "		/* @AS Issue_#1598: limited access to quick men� functionalities */
                           "                ",                          //"access code  \6\7\x08",
    #ifdef ABIL_CAPPUCCINATORE
...
const u8 __far ML_MS_NOME_PRESEL_1[MAX_NOME_PRESEL][16] = {
    ...
    /* 08 */          "@D009           ",                                //"SUGAR 1         ",  
    /* 09 */          "@D010           ",                                //"MORE SUGAR      ",  
    /* 10 */          "@D011           ",                                //"SELECTIONS 37-48",
    /* 11 */          "@D012           ",                                //"LONG            ",  
    /* 12 */          "@D013           ",                                //"JUG             ",
    /* 13 */          "@D028           ",                                //"SELECTIONS 49-60"
};
#else

const u8 __far ML_MS_NOME_PRESEL_1[MAX_NOME_PRESEL][7] = { //@FT controllare l'excel per il multilingua perch� si e' disallineato
    ...
    /* 09 */          "@D023  ",                                //"SUG.++ ",  
            #ifdef COMP_PREZZO_ECO_BIC
    /* 10 */          "@D024  ",                                //"BIG CUP",//st- presel per + 10 selezioni dirette  (sel 21-30) ( presel Nr 7 - mes 188 ) / ( presel 0 + 7 = sel 31-40 )  
            #else
    /* 10 */          "@D025  ",                                //"       ",         
            #endif
    /* 11 */          "@D026  ",                                //"LONG   ",  
...
const u8 __far  ML_MSG_LAV_GRUPPO[MAX_LAV_GRUPPO][32] = {
    ...
    /* MSA n. 8  */   "@M012           "                                 //"13/16 Skip final" 	//richiesta per il caff� di pulizia al termine del lavaggio sanitario
                      "                ",                                // "coffee YES=1    ",
...
const u8 __far ML_MES_ERRORI_AGGIUNTI[MAX_MES_ERRORI_AGGIUNTI][32] = {
    ...
    /*  n. 1   */      "@N002           "                                 //"           drain"  " Veuillez vider "  //OFF 3  = 
                       "                ",                                //"drip tray       ", "bac r�cup�ration",
    /*  n. 2   */      "@N003           "                                 //"  out of service"  "    Hors Service" //OFF 6a / 6b  = 
                       "                ",                                //"NO WATER        ", "pas d'eau       ", 
    /*  n. 3   */      "@N004           "                                 //" Water flow too "  "D�bit d'eau trop" //OFF 7  = 
                       "                ",                                //"low in H.circuit", "faible circuit.H",
    /*  n. 4   */      "@N005           "                                 //"           CHECK"	"       CONTR�LER" //OFF 8 / 8b = 
                       "                ",                                //"BREWER          ",	"BREWER          ", 											
    /*  n. 5   */      "@N006           "                                 //" REFILL COFFEE  "  "REMPLIR LE CAF� " //OFF 9a / 9d  = 
                       "                ",                                //"                ", "                ",
   #else
    /*  n. 1   */      "@N007           "                                 //"           drain"  "Vider le bac des"   //OFF 3  =   
                       "                ",                                //"drip tray       ", "eaux us�es      ",
    ...
    /*  n. 4   */      "@N010           "                                 //"           CHECK"	"   Contr�ler le "	 //OFF 8 / 8b =  
                       "                ",                                //"BREWER          ",	"groupe � caf�   ",											
    /*  n. 5   */      "@N011           "                                 //" REFILL COFFEE  "  "Contr�ler bac   "  
                       "                ",                                //"                ", "caf� et moulin  ",
  #endif
    /*  n. 6   */      "@N012           "                                 //"                "
                       "                ",                                //"                ",
...
const u8 __far  ML_MSAP_ParGrEspresso[MAX_ParGrEspresso][32] = {
    ...
    /* MSA n. 6  */    "@P010�\x08         "                              //"GRINDER FUNCTION"          		//Modalit� funzionamento macina:
                       "                ",                                //"IM EN/GR 1=yes \x08", 			//0--> GR/SEC 1--> IMP/GR
    /* MSA n. 7  */    "@P011           "                                 //"    NOT USED    "          		//Non usato
                       "                ",                                //"                ",
    /* MSA n. 8  */    "@P012�\x08         "                              //"GRIND 2 FUNCTION"          		//Modalit� funzionamento seconda macina:
                       "                ",                                //"IM EN/GR 1=yes \x08", 			//0--> GR/SEC 1--> IMP/GR
#ifdef ENABLE_BREWER_VARIFLEX
...
{
    /* MSP n. 0 */      "@R001           ",                                //"   disabled     ",
    /* MSP n. 1 */      "@R002           ",                                //"     fine       ",
    /* MSP n. 2 */      "@R003           ",                                //"    referring   ",
    /* MSP n. 3 */      "@R004           ",                                //"    roughly     ",
...
{
    /* MSP n. 0 */      "@T001           ",                                //"stirrers sugar  ",
    /* MSP n. 1 */      "@T002           ",                                //"stirrers no sug.",
    /* MSP n. 2 */      "@T003           ",                                //"stirrers always ",
    /* MSP n. 3 */      "@T004           ",                                //"stirrers never  ",
};
